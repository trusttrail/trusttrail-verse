        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-4">
            ...
            <div className="flex flex-col items-center p-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:bg-card/80 transition-all duration-300 min-h-[280px]">
              ...
              <h3 className="font-semibold text-xl mb-4 text-center">Trust-Based Rewards</h3>
              <p className="text-muted-foreground text-center leading-relaxed">
                Earn $NOCAP tokens with rewards calculated based on your Trust score - determined by review quality, engagement, and community feedback
              </p>
            </div>
            ...
            <div className="flex flex-col items-center p-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 hover:bg-card/80 transition-all duration-300 min-h-[280px]">
              ...
              <p className="text-muted-foreground text-center leading-relaxed">
                Gitcoin Passport verification prevents bots and fake accounts, ensuring authentic reviews from real Web3 users in our ecosystem
              </p>
            </div>
          </div>
        </div>
