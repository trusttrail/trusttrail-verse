...
import { Twitter, Shield, MessageSquare } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-foreground/70 mb-4">
              Blockchain-verified reviews with token rewards for genuine feedback
            </p>
            <div className="flex space-x-4">
              <a 
                href="https://twitter.com/trusttrail69" 
                target="_blank" 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-foreground transition-colors">Token Metrics</a></li>
